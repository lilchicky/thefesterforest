...
public class PetSpawnHandlerProvider<HANDLER> extends TFFCapabilityProvider<HANDLER> implements INBTSerializable<Tag> {
	
	private final INBTSerializable<Tag> serializableInstance;
	
	@SuppressWarnings("unchecked")
	public PetSpawnHandlerProvider(final Capability<HANDLER> cap, @Nullable final Direction facing, final HANDLER instance) {
