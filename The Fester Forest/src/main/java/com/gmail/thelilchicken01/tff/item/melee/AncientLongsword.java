...
public class AncientLongsword extends SwordItem {
	...
	public void appendHoverText(ItemStack stack, Level world, List<Component> lore, TooltipFlag flag) {
		...
		lore.add(new TextComponent("A once very powerful blade, now").withStyle(ChatFormatting.GRAY));
		lore.add(new TextComponent("chipped and falling apart.").withStyle(ChatFormatting.GRAY));
		lore.add(new TextComponent(""));
