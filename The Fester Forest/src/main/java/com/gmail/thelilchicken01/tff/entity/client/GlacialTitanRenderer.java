...
public class GlacialTitanRenderer extends GeoEntityRenderer<GlacialTitanEntity> {

	public GlacialTitanRenderer(EntityRendererProvider.Context renderManager) {
		super(renderManager, new GlacialTitanModel());
		this.shadowRadius = 0.5f;
	}

	@Override
	public ResourceLocation getTextureLocation(GlacialTitanEntity animatable) {
		
		return new ResourceLocation(TheFesterForest.MODID, "textures/entity/glacial_titan/glacial_titan.png");
	}
	
	@Override
	public RenderType getRenderType(GlacialTitanEntity animatable, float partialTick, PoseStack poseStack,
