...
public class IceCastle extends StructureFeature<JigsawConfiguration> {
    ...
    public IceCastle() {
        ...
        super(CODEC, IceCastle::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!IceCastle.isFeatureChunk(context)) {
