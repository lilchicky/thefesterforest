...
public abstract class NoParticleProjectile extends Projectile {
   public double xPower;
   public double yPower;
   public double zPower;

   protected NoParticleProjectile(EntityType<? extends NoParticleProjectile> p_36833_, Level p_36834_) {
      super(p_36833_, p_36834_);
   }

   public NoParticleProjectile(EntityType<? extends NoParticleProjectile> p_36817_, double p_36818_, double p_36819_, double p_36820_, double p_36821_, double p_36822_, double p_36823_, Level p_36824_) {
   ...
   public NoParticleProjectile(EntityType<? extends NoParticleProjectile> p_36826_, LivingEntity p_36827_, double p_36828_, double p_36829_, double p_36830_, Level p_36831_) {
