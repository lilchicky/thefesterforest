...
public class ModLootTableProvider extends BaseLootTableProvider {
	...
	protected void addTables() {
		...
		dropSelf(BlockInit.SLIMY_BUTTON.get());
		dropSelf(BlockInit.SLIMY_TRAPDOOR.get());
		dropSelf(BlockInit.SLIMY_PRESSURE_PLATE.get());
		
		dropSelf(BlockInit.FROSTBITTEN_BUTTON.get());
		dropSelf(BlockInit.FROSTBITTEN_TRAPDOOR.get());
		dropSelf(BlockInit.FROSTBITTEN_PRESSURE_PLATE.get());
		
		dropSelf(BlockInit.CUBED_FUNGUS_BUTTON.get());
		...
		dropSelf(BlockInit.FESTER_BRICK_PRESSURE_PLATE.get());
		
		dropSelf(BlockInit.COMPRESSED_ROTTING_SAND_BUTTON.get());
		dropSelf(BlockInit.COMPRESSED_ROTTING_SAND_PRESSURE_PLATE.get());
