...
public class AmbectrumDonut extends Item {
	...
	public void appendHoverText(ItemStack p_41421_, Level p_41422_, List<Component> lore, TooltipFlag p_41424_) {
		...
		lore.add(new TextComponent("A delicous, sweet donut coated in a").withStyle(ChatFormatting.GRAY));
		lore.add(new TextComponent("layer of Ambectrum jelly.").withStyle(ChatFormatting.GRAY));
		lore.add(new TextComponent(""));
