...
public class SmallGoopEntity extends Monster implements IAnimatable {
	
	private AnimationFactory factory = new AnimationFactory(this);

	public SmallGoopEntity(EntityType<? extends Monster> p_33002_, Level p_33003_) {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new SmallGoopEntity.GoopEntityFloatGoal(this));
	    this.goalSelector.addGoal(2, new SmallGoopEntity.GoopAttackGoal(this));
	    this.goalSelector.addGoal(3, new SmallGoopEntity.GoopEntityRandomDirectionGoal(this));
	    this.goalSelector.addGoal(5, new SmallGoopEntity.GoopEntityKeepOnJumpingGoal(this));
	...
	protected void playStepSound(BlockPos pos, BlockState blockIn) {
		...
		this.playSound(SoundEvents.HONEY_BLOCK_BREAK, 0.0f, 0.9f); // VOLUME - PITCH
	...
	static class GoopAttackGoal extends Goal {
	      private final SmallGoopEntity goop;
	      private int growTiredTimer;

	      public GoopAttackGoal(SmallGoopEntity p_33648_) {
	         this.goop = p_33648_;
	      ...
	      public boolean canUse() {
	         ...
	         if (livingentity == null) {
	            ...
	            return !this.goop.canAttack(livingentity) ? false : this.goop.getMoveControl() instanceof SmallGoopEntity.GoopMoveControl;
	         }
	      }
	      ...
	      public void tick() {
	         ...
	         ((SmallGoopEntity.GoopMoveControl)this.goop.getMoveControl()).setDirection(this.goop.getYRot());
	      }
	   }
	   ...
	   static class GoopEntityFloatGoal extends Goal {
	      ...
	      public GoopEntityFloatGoal(SmallGoopEntity p_33655_) {
	         this.goop = p_33655_;
	      ...
	      public boolean canUse() {
	         return (this.goop.isInWater() || this.goop.isInLava()) && this.goop.getMoveControl() instanceof SmallGoopEntity.GoopMoveControl;
	      }
	      ...
	      public void tick() {
	         ...
	         ((SmallGoopEntity.GoopMoveControl)this.goop.getMoveControl()).setWantedMovement(1.2D);
	      }
	   }
	   ...
	   static class GoopEntityKeepOnJumpingGoal extends Goal {
	      ...
	      public GoopEntityKeepOnJumpingGoal(SmallGoopEntity p_33660_) {
	         this.goop = p_33660_;
	         this.setFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
	      }
	      ...
	      public void tick() {
	         ((SmallGoopEntity.GoopMoveControl)this.goop.getMoveControl()).setWantedMovement(1.0D);
	      }
	   }
	   ...
	   static class GoopMoveControl extends MoveControl {
	      ...
	      public GoopMoveControl(SmallGoopEntity p_33668_) {
	         super(p_33668_);
	         this.goop = p_33668_;
	   ...
	   static class GoopEntityRandomDirectionGoal extends Goal {
	      ...
	      public GoopEntityRandomDirectionGoal(SmallGoopEntity p_33679_) {
	         this.goop = p_33679_;
	         this.setFlags(EnumSet.of(Goal.Flag.LOOK));
	      }

	      public boolean canUse() {
	         return this.goop.getTarget() == null && (this.goop.onGround || this.goop.isInWater() || this.goop.isInLava() || this.goop.hasEffect(MobEffects.LEVITATION)) && this.goop.getMoveControl() instanceof SmallGoopEntity.GoopMoveControl;
	      }
	      ...
	      public void tick() {
	         ...
	         ((SmallGoopEntity.GoopMoveControl)this.goop.getMoveControl()).setDirection(this.chosenDegrees);
	      }
	   }
