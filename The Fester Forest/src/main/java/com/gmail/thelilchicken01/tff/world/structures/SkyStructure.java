...
public class SkyStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public SkyStructure() {
        ...
        super(CODEC, SkyStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SkyStructure.isFeatureChunk(context)) {
