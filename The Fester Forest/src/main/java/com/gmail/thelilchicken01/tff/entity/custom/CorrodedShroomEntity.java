...
public class CorrodedShroomEntity extends Animal implements IAnimatable {
	
	private AnimationFactory factory = new AnimationFactory(this);

	public CorrodedShroomEntity(EntityType<? extends Animal> p_33002_, Level p_33003_) {
	...
	protected void playStepSound(BlockPos pos, BlockState blockIn) {
		...
		this.playSound(SoundEvents.STEM_BREAK, 0.1f, 1.0f); // VOLUME - PITCH
		
	}
	
	protected SoundEvent getAmbientSound() { return SoundEvents.FISH_SWIM; }
	
	protected SoundEvent getHurtSound(DamageSource damageSourceIn) {return SoundEvents.STEM_BREAK; }
	
	protected SoundEvent getDeathSound() {return SoundEvents.SOUL_SAND_BREAK; }
