...
public class FesterRocks extends StructureFeature<JigsawConfiguration> {
    ...
    public FesterRocks() {
        ...
        super(CODEC, FesterRocks::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!FesterRocks.isFeatureChunk(context)) {
