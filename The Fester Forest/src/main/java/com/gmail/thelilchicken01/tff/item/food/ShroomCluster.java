...
public class ShroomCluster extends Item {
	...
	public ShroomCluster() {
		super(new Properties().tab(TheFesterForest.TFF_TAB).food(
				new FoodProperties.Builder().saturationMod(0.35f).nutrition(6)
				.build()));
	}
	...
	public void appendHoverText(ItemStack p_41421_, Level p_41422_, List<Component> lore, TooltipFlag p_41424_) {
		...
		lore.add(new TextComponent("If you eat enough of them, they're bound").withStyle(ChatFormatting.GRAY));
		lore.add(new TextComponent("to be good for you.").withStyle(ChatFormatting.GRAY));
		lore.add(new TextComponent(""));
