...
public class MetalScrap extends Item {
	...
	public void appendHoverText(ItemStack stack, Level world, List<Component> lore, TooltipFlag flag) {
		...
		lore.add(new TextComponent("Some old scraps of the Forgemaster's armor.").withStyle(ChatFormatting.GRAY));
		lore.add(new TextComponent("Can be used to craft Forgemaster drops.").withStyle(ChatFormatting.GRAY));
		lore.add(new TextComponent(""));
