...
public class FloatingTower extends StructureFeature<JigsawConfiguration> {
    ...
    public static final Codec<JigsawConfiguration> CODEC = RecordCodecBuilder.create((codec) -> {
        return codec.group(
                ...
                Codec.intRange(0, 60).fieldOf("size").forGetter(JigsawConfiguration::maxDepth)
        ).apply(codec, JigsawConfiguration::new);
    });

    public FloatingTower() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, FloatingTower::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!FloatingTower.isFeatureChunk(context)) {
