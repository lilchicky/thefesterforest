...
public class ReetleCave extends StructureFeature<JigsawConfiguration> {
    ...
    public ReetleCave() {
        ...
        super(CODEC, ReetleCave::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!ReetleCave.isFeatureChunk(context)) {
