...
public class Boat extends StructureFeature<JigsawConfiguration> {
    ...
    public Boat() {
        ...
        super(CODEC, Boat::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!Boat.isFeatureChunk(context)) {
