...
public class BloodParticle extends TextureSheetParticle {
	...
	protected BloodParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet,
		...
		this.yd = yd;
		this.zd = zd;
		this.quadSize *= 2.0f; //size of particle
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType particleType, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
			...
			return new BloodParticle(world, x, y, z, this.sprites, xd, yd, zd);
