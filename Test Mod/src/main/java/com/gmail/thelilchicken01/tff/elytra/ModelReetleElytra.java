...
public class ModelReetleElytra extends HumanoidModel {
    private final ModelPart rightWing;
    private final ModelPart leftWing;

    public ModelReetleElytra(ModelPart part) {
        super(part);
    ...
    public ModelReetleElytra withAnimations(LivingEntity entity){
