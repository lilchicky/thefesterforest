...
public class PocketSandParticle extends TextureSheetParticle {

	protected PocketSandParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet,
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType particleType, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
			...
			return new PocketSandParticle(world, x, y, z, this.sprites, xd, yd, zd);
