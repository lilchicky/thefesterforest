...
public class TffPortalParticle extends TextureSheetParticle {

	protected TffPortalParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet,
		...
		this.lifetime = 20; //lifetime in ticks
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType particleType, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
			...
			return new TffPortalParticle(world, x, y, z, this.sprites, xd, yd, zd);
